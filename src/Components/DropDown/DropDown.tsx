...
export default function DropDown({ dropDownLabel, elements, isShowing, toggleDropDownList, dropDownWidth }: DropDownPropType) {
    ...
    return (
        <li className="dropDown" onClick={toggleDropDownList} ref={dropDownRef}>
            ...
            <ul className="dropDownList" style={style}>
